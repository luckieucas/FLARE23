...
from nnunetv2.utilities.connectivity_analysis import connectivity_analyze
...
class LabelManager(object):
    ...
    def convert_probabilities_to_segmentation(self, predicted_probabilities: Union[np.ndarray, torch.Tensor]) -> \
        ...
        """
        print(f"has regions: {self.has_regions}")
...
#        segmentation = connectivity_analyze(segmentation, 100)
        return segmentation
