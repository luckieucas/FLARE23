...
from nnunetv2.training.loss.compound_losses_cutmix import DC_CE_Partial_loss,DC_CE_Partial_Filter_loss,DC_CE_Partial_MergeProb_loss
from nnunetv2.training.loss.dice import MemoryEfficientSoftDiceLoss
from nnunetv2.utilities.collate_outputs import collate_outputs
from nnunetv2.training.loss.deep_supervision import DeepSupervisionWrapper
from nnunetv2.training.dataloading.nnunet_dataset import nnUNetDataset
from nnunetv2.training.dataloading.data_loader_3d_cutmix_unsup_lowres import nnUNetDataLoader3DPartial,nnUNetDataLoader3DPartialVal
...
class nnUNetTrainerFlarePseudoCutUnsupAddLow(nnUNetTrainerFlareMergeProb):
    def __init__(self, plans: dict, configuration: str, fold: int,
        ...
        self.different_partial_type_keys_json = join(
            ...
            "different_partial_type_filter_add.json")
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits_file = join(self.preprocessed_dataset_folder_base, "splits_final_add.json")
...
## TODO filter the 00 index in 0_13 type 
       ## partial_type = [item for item in partial_type if partial_type != 0]
